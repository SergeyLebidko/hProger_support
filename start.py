...
skills_data = [
    ...
    {
        'title': 'HTML/CSS',
        'tech': ('Семантическая верстка', 'Технология БЭМ', 'SCSS', 'Flexbox-верстка', 'Animation')
    }
]
...
projects_data = [
    ...
    },
    {
        ...
        'title': 'Abalone',
        'description': 'Реализация настольной игры "Абалон", созданной в 1987 году игровыми дизайнерами из Франции.',
        'tech': ('Python', 'pygame')
    },
    {
